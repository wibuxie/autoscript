...
curl https://raw.githubusercontent.com/wibuxie/autoscript/main/install/nginx.conf > /etc/nginx/nginx.conf
curl https://raw.githubusercontent.com/wibuxie/autoscript/main/install/vps.conf > /etc/nginx/conf.d/vps.conf
